...
- Name: product_interaction.spec.js >> Product Interaction - Detailed Cases >> Interested button should toggle heart color and increment count
- Location: tests\product_interaction.spec.js:36:3
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e46]:
    ...
    - paragraph [ref=e49]: The page you're looking for doesn't exist or has been removed.
    - link "← Back to homepage" [ref=e50] [cursor=pointer]:
      - /url: /
```
